...
program
  ...
  .option('--kind <kinds>', 'Comma-separated event kinds to show (e.g. job_log,job_stuck). Legacy worker_* event kinds still flow via dual-emit during the deprecation window.')
...
permissions
  ...
  .argument('<tool>', 'Tool id (e.g. job_dispatch, host_exec).')
