...
function renderIntentBand(d: HelmData): string {
  ...
  return [
    ...
    `</div>`,
    `<div class="band-arrow" data-parked="v0.7" title="Steward intent sheet — wiring lands in v0.7">› STEWARD</div>`,
    `</div>`,
    `<div class="band-rich">`,
    `<div class="l4-composer" data-parked="v0.7" aria-disabled="true" title="Composer is read-only until v0.7 — see audit/09-ui-substrate-gap.md">`,
    `<div class="label">Current intent</div>`,
    `<div class="input">${escapeHtml(intent)}</div>`,
    `<div class="meta">`,
    `<span>read-only · steward composer ships in v0.7</span>`,
    `<div class="chips">`,
