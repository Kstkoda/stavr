...
function renderDrawer(): string {
  ...
  return [
    ...
    `<div class="dt-window" role="group" data-parked="v0.7" title="Time-window filters are parked — page JS does not yet respect them (v0.7)">`,
    `<button data-window="5m" aria-pressed="true" aria-disabled="true">5m</button>`,
    `<button data-window="1h" aria-disabled="true">1h</button>`,
    `<button data-window="24h" aria-disabled="true">24h</button>`,
    `<button data-window="7d" aria-disabled="true">7d</button>`,
    `</div>`,
    `<div class="dt-charts" data-parked="v0.7" title="Per-node qps/p95/err/retry charts are parked — sparkline shapes are decorative; v0.7 wires /dashboard/api/topology/:nodeId/metrics">`,
    ...
    `<button class="dt-action" data-action="ping" type="button" disabled aria-disabled="true" title="Ping is parked — wiring lands in v0.7">Ping <span class="parked-pill">v0.7</span></button>`,
